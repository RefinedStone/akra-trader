...
2. keep moving query-builder replay intent, expression authoring, and coordination-simulation
   orchestration into feature-owned hooks and collaborators instead of re-expanding the main
   component body
