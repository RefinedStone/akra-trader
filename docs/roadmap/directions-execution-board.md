...
27. keep stitched report approval queue toggle-reset ownership directly above filter-select,
...
28. keep stitched report approval queue filter-select ownership split between queue-state, lane,
...
29. keep stitched report approval queue query-input ownership split between search-input binding and
