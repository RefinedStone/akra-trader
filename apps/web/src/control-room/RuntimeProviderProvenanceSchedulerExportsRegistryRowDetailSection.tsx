// @ts-nocheck
export function RuntimeProviderProvenanceSchedulerExportsRegistryRowDetailSection({
  entry,
}: {
  entry: any;
}) {
  return (
    <>
      ...
      <td>
        ...
        <p className="run-lineage-symbol-copy">Scope {formatWorkflowToken(entry.export_scope)}</p>
        <p className="run-lineage-symbol-copy">
