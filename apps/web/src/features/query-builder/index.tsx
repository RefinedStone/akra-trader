...
function formatComparisonTooltipConflictSessionRelativeTime(timestamp: number, now: Date) {
...
function getRunSurfaceCollectionQueryExpressionAuthoring(
  contract: RunSurfaceCollectionQueryContract | null | undefined,
): RunSurfaceCollectionQueryExpressionAuthoring {
...
type RunSurfaceCollectionQueryBuilderPredicateTemplateGroupState = {
  key: string;
  label: string;
  helpNote: string;
...
function buildRunSurfaceCollectionQueryRuntimeCandidateSampleKey(
...
function buildRunSurfaceCollectionQueryRuntimeCandidateTraceFromClause(params: {
...
type PredicateRefReplayApplyHistoryTabIdentity = {
  label: string;
  tabId: string;
};
...
type RunSurfaceCollectionQueryBuilderReplayIntentStorageState = {
  intentsByTemplateId: Record<string, RunSurfaceCollectionQueryBuilderReplayIntentSnapshot>;
  version: number;
};

type RunSurfaceCollectionQueryBuilderReplayIntentBrowserState = {
...
type RunSurfaceCollectionQueryBuilderReplayLinkAuditState = {
...
function buildRunSurfaceCollectionQueryBuilderReplayApplyHistoryTabId() {
...
function formatRunSurfaceCollectionQueryBuilderReplayApplyHistoryTabLabel(tabId: string) {
  return `Tab ${tabId.replace(/[^a-z0-9]/gi, "").slice(0, 4).toUpperCase() || "REPL"}`;
}

function loadRunSurfaceCollectionQueryBuilderReplayApplyHistoryTabIdentity(): PredicateRefReplayApplyHistoryTabIdentity {
...
function normalizeRunSurfaceCollectionQueryBuilderReplayIntentSnapshot(
...
function areRunSurfaceCollectionQueryBuilderReplayIntentsEqual(
...
function readRunSurfaceCollectionQueryBuilderReplayIntentStorageState(
...
function readRunSurfaceCollectionQueryBuilderReplayIntentBrowserState(
  value: unknown,
...
function buildRunSurfaceCollectionQueryBuilderReplayIntentBrowserState(
...
function isDefaultRunSurfaceCollectionQueryBuilderReplayIntent(
...
function buildRunSurfaceCollectionQueryBuilderReplayIntentUrl(
...
function applyRunSurfaceCollectionQueryBuilderReplayIntentRedactionPolicy(
  intent: RunSurfaceCollectionQueryBuilderReplayIntentSnapshot,
...
function loadRunSurfaceCollectionQueryBuilderReplayLinkAliasesFromStorageValue(
  raw: string | null | undefined,
) {
  if (typeof window === "undefined") {
...
function persistRunSurfaceCollectionQueryBuilderReplayLinkAliases(
  aliases: RunSurfaceCollectionQueryBuilderReplayLinkAliasEntry[],
) {
  if (typeof window === "undefined") {
    return;
...
function loadRunSurfaceCollectionQueryBuilderReplayLinkAuditTrail() {
...
function loadRunSurfaceCollectionQueryBuilderReplayLinkAuditTrailFromStorageValue(
  raw: string | null | undefined,
) {
  if (typeof window === "undefined") {
...
function persistRunSurfaceCollectionQueryBuilderReplayLinkAuditTrail(
  entries: RunSurfaceCollectionQueryBuilderReplayLinkAuditEntry[],
) {
  if (typeof window === "undefined") {
    return;
...
function persistRunSurfaceCollectionQueryBuilderReplayLinkGovernanceState(
  state: {
    redactionPolicy: RunSurfaceCollectionQueryBuilderReplayLinkRedactionPolicy;
    reviewedConflictKeys: string[];
    retentionPolicy: RunSurfaceCollectionQueryBuilderReplayLinkRetentionPolicy;
...
function mergeRunSurfaceCollectionQueryBuilderReplayLinkAliases(
...
function limitRunSurfaceCollectionQueryBuilderReplayLinkGovernanceReviewedConflictKeys(keys: string[]) {
  const seen = new Set<string>();
...
function limitRunSurfaceCollectionQueryBuilderReplayLinkGovernanceConflicts(
...
function persistRunSurfaceCollectionQueryBuilderReplayIntent(
...
function persistRunSurfaceCollectionQueryBuilderReplayApplySyncAuditTrail(
  tabId: string,
  entries: PredicateRefReplayApplySyncAuditEntry[],
) {
  if (typeof window === "undefined") {
...
function normalizeRunSurfaceCollectionQueryBuilderTemplateGroupKey(groupName: string) {
...
function mergeRunSurfaceCollectionQueryBuilderTemplateGroups(
  parameters: RunSurfaceCollectionQueryBuilderPredicateTemplateParameterState[],
...
function groupRunSurfaceCollectionQueryBuilderTemplateParameters(
  parameters: RunSurfaceCollectionQueryBuilderPredicateTemplateParameterState[],
...
function collectRunSurfaceCollectionQueryBuilderTemplateParametersFromClause(
  clause: HydratedRunSurfaceCollectionQueryBuilderState,
  contracts: RunSurfaceCollectionQueryContract[],
) {
  const activeContract =
...
type RunSurfaceCollectionQueryRuntimeCandidatePreviewDiffItem = {
  detail: string;
  key: string;
  runId: string;
};
...
export function RunSurfaceCollectionQueryBuilder({
  ...
  const currentRunSurfaceCollectionQueryBuilderReplayIntent = useMemo<RunSurfaceCollectionQueryBuilderReplayIntentSnapshot>(
    () => ({
  ...
  const handleIncomingReplayIntentGovernanceSyncState = useCallback(
    (
      remoteGovernance: RunSurfaceCollectionQueryBuilderReplayLinkGovernanceSyncState | null,
  ...
  }, [replayIntentGovernanceConflicts.length, replayIntentGovernanceSyncMode]);
  useEffect(() => {
    setReplayIntentGovernanceConflicts((current) =>
