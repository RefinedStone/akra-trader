...
import { QueryBuilderReplayCollisionReviewSection } from "./QueryBuilderReplayCollisionReviewSection";
...
import { QueryBuilderReplayStepActionReviewSection } from "./QueryBuilderReplayStepActionReviewSection";
import { QueryBuilderSimulationDiffReviewSection } from "./QueryBuilderSimulationDiffReviewSection";
import {
...
export function RunSurfaceCollectionQueryBuilder({
  ...
  const runtimeCandidateReviewProps = {
    activeRuntimeCandidateRunContext,
    contracts,
    editorClauseState,
    focusedRuntimeCandidateSampleKey,
    onFocusRuntimeCandidateClauseEditor: focusRuntimeCandidateClauseEditor,
    onFocusRuntimeCandidateRunContext,
    persistedRuntimeCandidateArtifactSelection: effectivePersistedRuntimeCandidateArtifactSelection,
    pinnedRuntimeCandidateClauseDiffItems,
    pinnedRuntimeCandidateClauseOriginKey,
                  ...
                  {simulatedCoordinationGroups.length ? (
                    <div className="run-surface-query-builder-trace-grid">
                      ...
                      <div className="run-surface-query-builder-trace-panel is-global" ref={bundleCoordinationSimulationPanelRef}>
                        ...
                        <QueryBuilderReplayCollisionReviewSection
                          callbacks={{
                            clearReviewOverride: () => setPredicateRefReplayApplyConflictSimulationConflictId(null),
                            focusConflictDecision: focusPredicateRefReplayApplyConflictDecision,
                            setReplayIndex: setBundleCoordinationSimulationReplayIndex,
                            toggleFieldPickSource: togglePredicateRefReplayApplyConflictSimulationFieldPickSource,
                          }}
                          review={{
                            activeReview: activePredicateRefReplayApplyConflictSimulationReview,
                            activeStepIndex: activeSimulatedPredicateRefSolverReplayIndex,
                            focusedChainExplanations:
                              activePredicateRefReplayApplyConflictSimulationFocusedChainExplanations,
                            focusedDecision: predicateRefReplayApplyConflictFocusedDecision,
                            focusedGroupKey: activePredicateRefReplayApplyConflictSimulationFocusedGroupKey,
                            focusedItemLabel:
                              activePredicateRefReplayApplyConflictSimulationFocusedItem?.label ?? null,
                            globalFieldPicks:
                              activePredicateRefReplayApplyConflictSimulationFieldPicks.global,
                            groupKeys: activePredicateRefReplayApplyConflictSimulationGroupKeys,
                            groupLabelsByKey:
                              activePredicateRefReplayApplyConflictSimulationBundleOverrides.groupLabelsByKey,
                          }}
                          runtimeCandidate={runtimeCandidateReviewProps}
                        />
                        <p className="run-note">
                          {simulatedPredicateRefGroupBundleState
                            ? (
                        ...
                        {simulatedPredicateRefGroupBundleState ? (
                          <>
                            ...
                            <QueryBuilderSimulationDiffReviewSection
                              callbacks={{
                                focusConflictDecision: focusPredicateRefReplayApplyConflictDecision,
                                focusRuntimeCandidateClauseEditor,
                              ...
                              clausePreview={{
                                diffItemRefs: clauseReevaluationPreviewDiffItemRefs,
                                selection: clauseReevaluationPreviewSelection,
                                traceRefs: clauseReevaluationPreviewTraceRefs,
                              }}
                              review={{
                                ...
                                attributionByGroupKey:
                                  simulatedPredicateRefSolverReplayAttributionByGroupKey,
                                diffs: simulatedPredicateRefGroupBundleDiffs,
                                fieldPicksByGroupKey:
                                  activePredicateRefReplayApplyConflictSimulationFieldPicks.byGroupKey,
                                focusedDecision: predicateRefReplayApplyConflictFocusedDecision,
                              ...
                              <div className="run-surface-query-builder-trace-panel is-nested">
                                ...
                                {activeSimulatedPredicateRefSolverReplayStep ? (
                                  <>
                                    ...
                                    <QueryBuilderReplayStepActionReviewSection
                                      callbacks={{
                                      ...
                                      review={{
                                        actionTypeFilter:
                                          bundleCoordinationSimulationReplayActionTypeFilter,
                                        activeReviewConflictId:
                                          activePredicateRefReplayApplyConflictSimulationReview?.conflict
                                            .conflictId ?? null,
                                        activeStep: activeSimulatedPredicateRefSolverReplayStep,
                                        activeStepIndex: activeSimulatedPredicateRefSolverReplayIndex,
                                        edgeFilter: bundleCoordinationSimulationReplayEdgeFilter,
                                        fieldPicksByGroupKey:
                                          activePredicateRefReplayApplyConflictSimulationFieldPicks.byGroupKey,
                                        filteredActions:
                                          activeSimulatedPredicateRefSolverReplayFilteredActions,
