import type { OperatorIncidentEventEntry } from "./operatorIncidentEvents";
export type OperatorAlertMarketContextFieldProvenance = {
scope?: string | null; path?: string | null;
};

export type OperatorAlertMarketContextProvenance = {
provider?: string | null; vendor_field?: string | null; symbol?: OperatorAlertMarketContextFieldProvenance | null; symbols?: OperatorAlertMarketContextFieldProvenance | null;
timeframe?: OperatorAlertMarketContextFieldProvenance | null; primary_focus?: OperatorAlertMarketContextFieldProvenance | null;
};

export type OperatorAlertPrimaryFocus = {
symbol?: string | null; timeframe?: string | null;
  candidate_symbols: string[];
candidate_count: number; policy: string; reason?: string | null;
};

export type OperatorAlertEntry = {
alert_id: string; severity: string; category: string; summary: string;
detail: string; detected_at: string; run_id?: string | null; session_id?: string | null;
symbol?: string | null;
  symbols: string[];
timeframe?: string | null; primary_focus?: OperatorAlertPrimaryFocus | null; occurrence_id?: string | null; timeline_key?: string | null;
timeline_position?: number | null; timeline_total?: number | null; status: string; resolved_at?: string | null;
source: string;
...
generated_at: string;
  ...
  incident_events: OperatorIncidentEventEntry[];
  delivery_history: {
delivery_id: string; incident_event_id: string; alert_id: string; incident_kind: string;
target: string; status: string; attempted_at: string; detail: string;
attempt_number: number; next_retry_at?: string | null; phase: string; provider_action?: string | null;
external_provider?: string | null; external_reference?: string | null; source: string;
  }[];
  audit_events: {
event_id: string; timestamp: string; actor: string; kind: string;
summary: string; detail: string; run_id?: string | null; session_id?: string | null;
source: string;
  }[];
};

export type GuardedLiveStatus = {
generated_at: string; candidacy_status: string;
  blockers: string[];
...
workflow_reference?: string | null; summary?: string | null; detail?: string | null;
        channels: string[];
        symbols: string[];
timeframe?: string | null; updated_at?: string | null;
        verification: {
...
external_provider?: string | null; external_reference?: string | null; source: string;
  ...
  kill_switch: {
state: string; reason: string; updated_at: string; updated_by: string;
activation_count: number; last_engaged_at?: string | null; last_released_at?: string | null;
  };
  reconciliation: {
state: string; checked_at?: string | null; checked_by?: string | null; scope: string;
summary: string;
    findings: {
kind: string; severity: string; summary: string; detail: string;
    }[];
    internal_snapshot?: {
captured_at: string;
      running_run_ids: string[];
      exposures: {
run_id: string; mode: string; instrument_id: string; quantity: number;
      }[];
open_order_count: number;
    } | null;
    venue_snapshot?: {
provider: string; venue: string; verification_state: string; captured_at?: string | null;
      balances: {
asset: string; total: number; free?: number | null; used?: number | null;
      }[];
      open_orders: {
order_id: string; symbol: string; side: string; amount: number;
status: string; price?: number | null;
  ...
  recovery: {
state: string; recovered_at?: string | null; recovered_by?: string | null; reason?: string | null;
source_snapshot_at?: string | null; source_verification_state: string; summary: string;
    exposures: {
instrument_id: string; symbol: string; asset: string; quantity: number;
    }[];
    open_orders: {
order_id: string; symbol: string; side: string; amount: number;
status: string; price?: number | null;
  ...
  ownership: {
state: string; owner_run_id?: string | null; owner_session_id?: string | null; symbol?: string | null;
claimed_at?: string | null; claimed_by?: string | null; last_heartbeat_at?: string | null; last_order_sync_at?: string | null;
last_resumed_at?: string | null; last_reason?: string | null; last_released_at?: string | null;
  };
  order_book: {
state: string; synced_at?: string | null; owner_run_id?: string | null; owner_session_id?: string | null;
symbol?: string | null;
    open_orders: {
order_id: string; symbol: string; side: string; amount: number;
status: string; price?: number | null;
  ...
  session_restore: {
state: string; restored_at?: string | null; source: string; venue?: string | null;
symbol?: string | null; owner_run_id?: string | null; owner_session_id?: string | null;
    open_orders: {
order_id: string; symbol: string; side: string; amount: number;
status: string; price?: number | null;
    }[];
    synced_orders: {
order_id: string; venue: string; symbol: string; side: string;
amount: number; status: string; submitted_at: string; updated_at?: string | null;
requested_price?: number | null; average_fill_price?: number | null; fee_paid?: number | null; requested_amount?: number | null;
filled_amount?: number | null; remaining_amount?: number | null;
      issues: string[];
    }[];
    issues: string[];
  };
  session_handoff: {
state: string; handed_off_at?: string | null; released_at?: string | null; source: string;
venue?: string | null; symbol?: string | null; owner_run_id?: string | null; owner_session_id?: string | null;
venue_session_id?: string | null; transport: string; cursor?: string | null; last_event_at?: string | null;
last_sync_at?: string | null; supervision_state: string; failover_count: number; last_failover_at?: string | null;
    coverage: string[];
order_book_state: string; order_book_last_update_id?: number | null; order_book_gap_count: number; order_book_rebuild_count: number;
order_book_last_rebuilt_at?: string | null; order_book_bid_level_count: number; order_book_ask_level_count: number; order_book_best_bid_price?: number | null;
order_book_best_bid_quantity?: number | null; order_book_best_ask_price?: number | null; order_book_best_ask_quantity?: number | null;
    order_book_bids: {
...
channel_restore_state: string; channel_restore_count: number; channel_last_restored_at?: string | null; channel_continuation_state: string;
channel_continuation_count: number; channel_last_continued_at?: string | null;
    trade_snapshot?: {
event_id?: string | null; price?: number | null; quantity?: number | null; event_at?: string | null;
    } | null;
    aggregate_trade_snapshot?: {
event_id?: string | null; price?: number | null; quantity?: number | null; event_at?: string | null;
    } | null;
    book_ticker_snapshot?: {
bid_price?: number | null; bid_quantity?: number | null; ask_price?: number | null; ask_quantity?: number | null;
event_at?: string | null;
    } | null;
    mini_ticker_snapshot?: {
open_price?: number | null; close_price?: number | null; high_price?: number | null; low_price?: number | null;
base_volume?: number | null; quote_volume?: number | null; event_at?: string | null;
    } | null;
    kline_snapshot?: {
timeframe?: string | null; open_at?: string | null; close_at?: string | null; open_price?: number | null;
high_price?: number | null; low_price?: number | null; close_price?: number | null; volume?: number | null;
closed: boolean; event_at?: string | null;
    } | null;
last_market_event_at?: string | null; last_depth_event_at?: string | null; last_kline_event_at?: string | null; last_aggregate_trade_event_at?: string | null;
last_mini_ticker_event_at?: string | null; last_account_event_at?: string | null; last_balance_event_at?: string | null; last_order_list_event_at?: string | null;
last_trade_event_at?: string | null; last_book_ticker_event_at?: string | null; active_order_count: number;
    issues: string[];
  };
  audit_events: {
event_id: string; timestamp: string; actor: string; kind: string;
...
active_runtime_alert_count: number; running_sandbox_count: number; running_paper_count: number; running_live_count: number;
};
