...
- guarded-live incident delivery now supports console, generic webhook, Slack webhook, PagerDuty
  Events API, incident.io, FireHydrant, Rootly, Blameless, xMatters, ServiceNow, Squadcast, BigPanda, Grafana OnCall, Splunk On-Call, Jira Service Management, PagerTree, AlertOps, SIGNL4, iLert, Better Stack, OnPage, All Quiet, Moogsoft, Spike.sh, DutyCalls, IncidentHub, Resolver, OpenDuty, Cabot, HaloITSM, incidentmanager.io, OneUptime, Squzy, Crises Control, Freshservice, Freshdesk, HappyFox, Zendesk, Zoho Desk, Help Scout, Kayako, Intercom, ManageEngine ServiceDesk Plus, SysAid, BMC Helix, SolarWinds Service Desk, TOPdesk, InvGate Service Desk, OpsRamp, Zenduty, and Opsgenie Alert API targets with persisted attempt history, operator
...
- full external incident-management workflow such as provider-managed incident ownership beyond the
  current PagerDuty/incident.io/FireHydrant/Rootly/Blameless/xMatters/ServiceNow/Squadcast/BigPanda/Grafana OnCall/Splunk On-Call/Jira Service Management/PagerTree/AlertOps/SIGNL4/iLert/BetterStack/OnPage/AllQuiet/Moogsoft/SpikeSh/DutyCalls/IncidentHub/Resolver/OpenDuty/Cabot/HaloITSM/incidentmanager.io/OneUptime/Squzy/CrisesControl/Freshservice/Freshdesk/HappyFox/Zendesk/ZohoDesk/HelpScout/ServiceDeskPlus/SysAid/BMCHelix/SolarWindsServiceDesk/TOPdesk/InvGateServiceDesk/OpsRamp/Zenduty/Opsgenie-native bidirectional paths, richer escalation ladders, and broader
...
- `AKRA_TRADER_OPERATOR_ALERT_ZENDESK_API_TOKEN`
...
- `AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_API_TOKEN`
- `AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_API_URL`
- `AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_RECOVERY_ENGINE_URL_TEMPLATE`
- `AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_RECOVERY_ENGINE_TOKEN`
- `AKRA_TRADER_OPERATOR_ALERT_KAYAKO_API_TOKEN`
- `AKRA_TRADER_OPERATOR_ALERT_KAYAKO_API_URL`
- `AKRA_TRADER_OPERATOR_ALERT_KAYAKO_RECOVERY_ENGINE_URL_TEMPLATE`
- `AKRA_TRADER_OPERATOR_ALERT_KAYAKO_RECOVERY_ENGINE_TOKEN`
- `AKRA_TRADER_OPERATOR_ALERT_INTERCOM_API_TOKEN`
- `AKRA_TRADER_OPERATOR_ALERT_INTERCOM_API_URL`
- `AKRA_TRADER_OPERATOR_ALERT_INTERCOM_RECOVERY_ENGINE_URL_TEMPLATE`
- `AKRA_TRADER_OPERATOR_ALERT_INTERCOM_RECOVERY_ENGINE_TOKEN`
...
- external paging systems can now push `triggered`, `acknowledged`, `escalated`, `resolved`, and
  ...
  count. Guarded-live state refresh now also pull-syncs the current PagerDuty/incident.io/FireHydrant/Rootly/Blameless/xMatters/ServiceNow/Squadcast/BigPanda/Grafana OnCall/Splunk On-Call/Jira Service Management/PagerTree/AlertOps/SIGNL4/iLert/BetterStack/OnPage/AllQuiet/Moogsoft/SpikeSh/DutyCalls/IncidentHub/Resolver/OpenDuty/Cabot/HaloITSM/incidentmanager.io/OneUptime/Squzy/CrisesControl/Freshservice/Freshdesk/HappyFox/Zendesk/ZohoDesk/HelpScout/ServiceDeskPlus/SysAid/BMCHelix/SolarWindsServiceDesk/TOPdesk/InvGateServiceDesk/OpsRamp/Zenduty/Opsgenie
