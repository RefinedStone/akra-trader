...
def test_standalone_binding_routes_expose_generated_signatures(tmp_path: Path) -> None:
  ...
  assert tuple(inspect.signature(routes["create_operator_provider_provenance_scheduler_stitched_report_view"].endpoint).parameters) == (
    "request",
    "app",
  )
  assert tuple(inspect.signature(routes["list_operator_provider_provenance_scheduler_stitched_report_views"].endpoint).parameters) == (
    "request",
    "filter_expr",
    "created_by_tab_id",
    "category",
  ...
  assert tuple(inspect.signature(routes["update_operator_provider_provenance_scheduler_stitched_report_view"].endpoint).parameters) == (
    "view_id",
    "request",
    "app",
  )
  assert tuple(inspect.signature(routes["delete_operator_provider_provenance_scheduler_stitched_report_view"].endpoint).parameters) == (
    "view_id",
    "request",
    "app",
  )
  assert tuple(inspect.signature(routes["list_operator_provider_provenance_scheduler_stitched_report_view_revisions"].endpoint).parameters) == (
    "view_id",
    "app",
  )
  assert tuple(inspect.signature(routes["restore_operator_provider_provenance_scheduler_stitched_report_view_revision"].endpoint).parameters) == (
    "view_id",
    "revision_id",
    "request",
    "app",
  )
  assert tuple(inspect.signature(routes["bulk_govern_operator_provider_provenance_scheduler_stitched_report_views"].endpoint).parameters) == (
    "request",
    "app",
  )
  assert tuple(inspect.signature(routes["list_operator_provider_provenance_scheduler_stitched_report_view_audits"].endpoint).parameters) == (
    "request",
    "filter_expr",
    "view_id",
    "action",
...
def test_operator_provider_provenance_workspace_endpoints_round_trip(tmp_path: Path) -> None:
  ...
  assert updated_hierarchy_step_template_response.status_code == 200
  ...
  assert hierarchy_step_template_revision_response.status_code == 200
  hierarchy_step_template_revision_payload = hierarchy_step_template_revision_response.json()
  ...
  deleted_hierarchy_step_template_response = client.post(
    f"/api/operator/provider-provenance-analytics/scheduler-narrative-governance/hierarchy-step-templates/{hierarchy_step_template_payload['hierarchy_step_template_id']}/delete",
    json={
      "actor_tab_id": "tab_ops",
      "actor_tab_label": "Ops desk",
  ...
  assert deleted_hierarchy_step_template_response.status_code == 200
  deleted_hierarchy_step_template_payload = deleted_hierarchy_step_template_response.json()
  assert deleted_hierarchy_step_template_payload["status"] == "deleted"

  restored_hierarchy_step_template_response = client.post(
    f"/api/operator/provider-provenance-analytics/scheduler-narrative-governance/hierarchy-step-templates/{hierarchy_step_template_payload['hierarchy_step_template_id']}/revisions/{hierarchy_step_template_revision_payload['history'][0]['revision_id']}/restore",
    json={
      "actor_tab_id": "tab_ops",
      "actor_tab_label": "Ops desk",
  ...
  assert restored_hierarchy_step_template_response.status_code == 200
  restored_hierarchy_step_template_payload = restored_hierarchy_step_template_response.json()
  ...
  bulk_governed_hierarchy_step_template_response = client.post(
    "/api/operator/provider-provenance-analytics/scheduler-narrative-governance/hierarchy-step-templates/bulk-governance",
    json={
      "action": "update",
  ...
  assert bulk_governed_hierarchy_step_template_response.status_code == 200
...
def test_operator_provider_provenance_scheduler_alert_history_endpoint_paginates_occurrences(
  ...
  assert search_payload["search_summary"]["persistence_mode"] == "external_scheduler_search_backend"
...
def test_operator_visibility_endpoint_can_export_stitched_scheduler_narrative_report(
  ...
  assert stitched_report["stitched_occurrence_report"]["search_summary"]["persistence_mode"] == "external_scheduler_search_backend"
  assert (
