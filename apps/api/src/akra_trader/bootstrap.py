...
def build_operator_alert_delivery_adapter(settings: Settings) -> OperatorAlertDeliveryAdapter:
  return OperatorAlertDeliveryAdapter(
    ...
    freshdesk_api_token=settings.operator_alert_freshdesk_api_token,
    freshdesk_api_url=settings.operator_alert_freshdesk_api_url,
    freshdesk_recovery_engine_url_template=(
      settings.operator_alert_freshdesk_recovery_engine_url_template
    ),
    freshdesk_recovery_engine_token=settings.operator_alert_freshdesk_recovery_engine_token,
    happyfox_api_token=settings.operator_alert_happyfox_api_token,
    happyfox_api_url=settings.operator_alert_happyfox_api_url,
    ...
    zohodesk_api_token=settings.operator_alert_zohodesk_api_token,
    zohodesk_api_url=settings.operator_alert_zohodesk_api_url,
    ...
    intercom_api_token=settings.operator_alert_intercom_api_token,
    intercom_api_url=settings.operator_alert_intercom_api_url,
    ...
    solarwindsservicedesk_api_token=settings.operator_alert_solarwindsservicedesk_api_token,
    solarwindsservicedesk_api_url=settings.operator_alert_solarwindsservicedesk_api_url,
    solarwindsservicedesk_recovery_engine_url_template=(
      settings.operator_alert_solarwindsservicedesk_recovery_engine_url_template
    ),
    ...
    invgateservicedesk_api_token=settings.operator_alert_invgateservicedesk_api_token,
    invgateservicedesk_api_url=settings.operator_alert_invgateservicedesk_api_url,
    invgateservicedesk_recovery_engine_url_template=(
      settings.operator_alert_invgateservicedesk_recovery_engine_url_template
    ),
    invgateservicedesk_recovery_engine_token=(
      settings.operator_alert_invgateservicedesk_recovery_engine_token
    ),
