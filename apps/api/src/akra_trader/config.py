...
def load_settings() -> Settings:
  return Settings(
    ...
    operator_alert_crisescontrol_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_CRISESCONTROL_API_TOKEN") or None
    ),
    operator_alert_crisescontrol_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_CRISESCONTROL_API_URL",
      "https://api.crises-control.com/v1",
    ),
    operator_alert_crisescontrol_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_CRISESCONTROL_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_crisescontrol_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_CRISESCONTROL_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_freshservice_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_FRESHSERVICE_API_TOKEN") or None
    ),
    operator_alert_freshservice_api_url=os.getenv(
    ...
    operator_alert_freshservice_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_FRESHSERVICE_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    ...
    operator_alert_happyfox_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HAPPYFOX_API_TOKEN") or None
    ),
    operator_alert_happyfox_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_HAPPYFOX_API_URL",
      "https://api.happyfox.com/v1",
    ),
    operator_alert_happyfox_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HAPPYFOX_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_happyfox_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HAPPYFOX_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_zendesk_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZENDESK_API_TOKEN") or None
    ),
    operator_alert_zendesk_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_ZENDESK_API_URL",
      "https://api.zendesk.com/api/v2",
    ),
    operator_alert_zendesk_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZENDESK_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_zendesk_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZENDESK_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_zohodesk_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZOHODESK_API_TOKEN") or None
    ),
    operator_alert_zohodesk_api_url=os.getenv(
    ...
    operator_alert_zohodesk_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZOHODESK_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_zohodesk_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_ZOHODESK_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_helpscout_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_API_TOKEN") or None
    ),
    operator_alert_helpscout_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_API_URL",
      "https://api.helpscout.net/v2",
    ),
    operator_alert_helpscout_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_helpscout_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_HELPSCOUT_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_kayako_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_KAYAKO_API_TOKEN") or None
    ),
    operator_alert_kayako_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_KAYAKO_API_URL",
      "https://api.kayako.com/v1",
    ),
    operator_alert_kayako_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_KAYAKO_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    ...
    operator_alert_front_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_FRONT_API_TOKEN") or None
    ),
    operator_alert_front_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_FRONT_API_URL",
      "https://api2.frontapp.com",
    ),
    operator_alert_front_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_FRONT_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_front_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_FRONT_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_servicedeskplus_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SERVICEDESKPLUS_API_TOKEN") or None
    ),
    operator_alert_servicedeskplus_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_SERVICEDESKPLUS_API_URL",
      "https://api.manageengine.com/servicedeskplus/v3",
    ),
    operator_alert_servicedeskplus_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SERVICEDESKPLUS_RECOVERY_ENGINE_URL_TEMPLATE")
      or None
    ),
    operator_alert_servicedeskplus_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SERVICEDESKPLUS_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_sysaid_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SYSAID_API_TOKEN") or None
    ),
    operator_alert_sysaid_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_SYSAID_API_URL",
      "https://api.sysaid.com/v1",
    ),
    operator_alert_sysaid_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SYSAID_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_sysaid_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SYSAID_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_bmchelix_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_BMCHELIX_API_TOKEN") or None
    ),
    operator_alert_bmchelix_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_BMCHELIX_API_URL",
      "https://api.bmchelix.com/v1",
    ),
    operator_alert_bmchelix_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_BMCHELIX_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    operator_alert_bmchelix_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_BMCHELIX_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_solarwindsservicedesk_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SOLARWINDSSERVICEDESK_API_TOKEN") or None
    ),
    operator_alert_solarwindsservicedesk_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_SOLARWINDSSERVICEDESK_API_URL",
      "https://api.solarwinds.com/servicedesk/v1",
    ),
    operator_alert_solarwindsservicedesk_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SOLARWINDSSERVICEDESK_RECOVERY_ENGINE_URL_TEMPLATE")
      or None
    ),
    operator_alert_solarwindsservicedesk_recovery_engine_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_SOLARWINDSSERVICEDESK_RECOVERY_ENGINE_TOKEN") or None
    ),
    operator_alert_topdesk_api_token=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_TOPDESK_API_TOKEN") or None
    ),
    operator_alert_topdesk_api_url=os.getenv(
      "AKRA_TRADER_OPERATOR_ALERT_TOPDESK_API_URL",
      "https://api.topdesk.com/tas/api",
    ),
    operator_alert_topdesk_recovery_engine_url_template=(
      os.getenv("AKRA_TRADER_OPERATOR_ALERT_TOPDESK_RECOVERY_ENGINE_URL_TEMPLATE") or None
    ),
    ...
    replay_alias_audit_admin_read_token=(
      os.getenv("AKRA_TRADER_REPLAY_ALIAS_AUDIT_ADMIN_READ_TOKEN") or None
    ),
    replay_alias_audit_admin_write_token=(
      os.getenv("AKRA_TRADER_REPLAY_ALIAS_AUDIT_ADMIN_WRITE_TOKEN") or None
    ),
