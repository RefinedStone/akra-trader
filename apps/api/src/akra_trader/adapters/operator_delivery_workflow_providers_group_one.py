...
from akra_trader.adapters.operator_delivery_bigpanda_workflow import OperatorDeliveryBigPandaWorkflowMixin
from akra_trader.adapters.operator_delivery_squadcast_workflow import OperatorDeliverySquadcastWorkflowMixin


class OperatorDeliveryWorkflowProvidersGroupOneMixin(
  OperatorDeliveryBigPandaWorkflowMixin,
  OperatorDeliverySquadcastWorkflowMixin,
):
